      ...
      <div class="container footer">
        <div class="row justify-content-center">
          <div class="col-4 hide_mobile">
            <h1 class="title-small">Quick links</h1>
            <ul class="footer-list">
              ...
              <!-- <li><a class="custom-link" href="">Portfolio</a></li> -->
            </ul>
          </div>
          <div class="col-4 hide_mobile">
            <h1 class="title-small">Social</h1>
            <ul class="footer-list">
              <li><a class="custom-link" target="blank" href="https://www.linkedin.com/in/pedro-arantes-a88099140/">LinkedIn</a></li>
              <li><a class="custom-link" target="blank" href="https://github.com/pharantes?tab=overview">Github</a></li>
              <li><a class="custom-link" href="mailto:pedro.hga90@gmail.com">Email</a></li>
            </ul>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col">
            <p class="copyright">
              Copyright © <span id="year"></span> - Pedro Arantes. All rights
              reserved.
            </p>
          </div>
        </div>
            ...
            <div class="modal-header">
              <div class="header">
                ...
                <h6 class="modal-title" id="exampleModalLongTitle">
                  Fill the form and I'll answer as soon as possible
                </h6>
              </div>
            ...
            <form id="hireme" name="hireme">
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    placeholder="jackbauer@example.com"
                  />
                ...
                <div class="form-group">
                  ...
                  <textarea
                    class="form-control"
                    id="description"
                    placeholder="Ex.: I need a landing page with a form to get feedback from my users..."
                    rows="6"
                  ></textarea>
                </div>
              </div>
              <div class="modal-footer">
                ...
                <div class="form__message">
                  <img alt="Imagem de refresh" src="/svg/ring.svg" class="refresh">
